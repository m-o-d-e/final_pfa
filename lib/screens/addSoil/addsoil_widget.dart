...
class _AddsoilWidgetState extends State<AddsoilWidget> {
  ...
  SoilModel soil1 = SoilModel(
      name: "light",
      path:
          "https://www.notcutts.co.uk/wordpress/wp-content/uploads/2018/09/sandy-soils.jpg");
  SoilModel soil2 = SoilModel(
      name: "heavy",
      path:
          "https://c7.alamy.com/comp/M4A2DW/dry-clay-soil-in-lanzarote-M4A2DW.jpg");
  SoilModel soil3 = SoilModel(
      name: "medium",
      path:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSPGT3xnLuSlxwl05It8mvHbQeJhFjesNKrgky0o91Rky5AlrhxH8kPcYIYxKfDLbWyxZw&usqp=CAU");
  List<SoilModel> list = [];
