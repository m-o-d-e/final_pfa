...
import 'package:rive_animation/models/crop.dart';
import '../../models/soil.dart';

import '../../utlis/framwork_utils.dart';
import '../addSoil/addsoil_model.dart';

class AddcropWidget extends StatefulWidget {
  const AddcropWidget({Key? key}) : super(key: key);

  @override
  _AddcropWidgetState createState() => _AddcropWidgetState();
}
...
class _AddcropWidgetState extends State<AddcropWidget> {
  ...
  CropModel crop1 = CropModel(
      name: "Olives",
      path:
          "https://media.istockphoto.com/id/1163001279/photo/olives-on-white.jpg?s=612x612&w=0&k=20&c=m0daixPthThxYoynPpEwu4OwwkKNbxA8V0AvjA5mAiI=");
  CropModel crop2 = CropModel(
      name: "Banane",
      path:
  ...
  CropModel crop3 = CropModel(
      name: "Citrus",
      path:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSuxiC_xw5CY1zPPEVyAkF2pmrJMe_0eyM6jQ&usqp=CAU");
  CropModel crop4 = CropModel(
      name: "Pommes De Terre",
      path:
          "https://png.pngtree.com/png-vector/20201024/ourmid/pngtree-clean-smooth-vegetable-potatoes-png-image_2371443.jpg");
  CropModel crop5 = CropModel(
      name: "Tomate",
      path:
          "https://img.freepik.com/free-photo/one-fresh-red-tomato-isolated-white_1205-548.jpg?1");
  CropModel crop6 = CropModel(
      name: "raisins",
      path:
          "https://img.freepik.com/premium-vector/isolated-dark-grape-with-green-leaf_317810-1956.jpg");
  CropModel crop7 = CropModel(
      name: "Poivre",
      path:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQl1ZCPhBTcO0YfhMNEiomKRE1bb6h-17pTOA&usqp=CAU");
  CropModel crop8 = CropModel(
      name: "betterave sucrière",
      path:
          "https://media.istockphoto.com/id/133455479/photo/picture-of-a-sugar-beet-on-a-white-background.jpg?s=612x612&w=0&k=20&c=t8qnek9qZRYK8_z5662UJITVhVV53P02AoIEsEwrwKE=");
  List<CropModel> list = [];
                                      ...
                                      child: GestureDetector(
                                        ...
                                        child: Container(
                                          ...
                                          decoration: BoxDecoration(
                                            color: index == selectedProductIndex
                                                ? Colors
                                                    .blue // Change the color for the selected product
                                                : Colors.grey,
                                            border: Border.all(
                                                color: index ==
